 ...
 * @LastEditors: Lee
 * @LastEditTime: 2021-11-04 14:58:18
-->

<template>
  <div class="page">
    <!-- 导航栏 -->
    <app-header title="钱包提现" backgroundColor="#FBDCB9" :showBack="true" />
    <!-- 内容 -->
    <div class="bg-FFFFFF px-17 pt-16 pb-35">
      <!-- 金币余额 -->
      <div class="pb-21 border-bottom" style="border-color: #97979720">
        <div class="f13 lh-20 mb-10" style="color: #00000050">可提金额</div>
        <div class="flex-h-start lh-20" style="color: #be701b">
...
.withdraw-button {
  width: 277px;
  height: 50px;
  background: linear-gradient(90deg, #fbc68b 0%, #be701b 100%);
