  ...
  <div class="tab-page px-12">
    <van-pull-refresh v-model="isRefreshing" @refresh="onRefresh">
      ...
      <div class="pt-36 px-17 flex-h-between">
        ...
        <img class="icon-gold" src="../../assets/icon_gold_shadow.png" />
      </div>
      <!-- 签到 -->
      ...
      >
        ...
        <div class="flex-h-between mb-26">
          <img class="icon-41x41 flex-shrink" src="../../assets/task_1.png" />
        ...
        <!-- 邀请好友 -->
        <div class="flex-h-between mb-26">
          <img class="icon-41x41 flex-shrink" src="../../assets/task_2.png" />
          <div class="flex-1 mx-10">
            <div class="f15 f-600 lh-21 color-555555 flex-h-start mb-3">
              <span>邀请好友</span>
              <span class="ml-7 mr-5" style="color: #fc3230">+50</span>
        ...
        <!-- 每日宝箱 -->
        <div class="flex-h-between">
          <img class="icon-41x41 flex-shrink" src="../../assets/task_3.png" />
          <div class="flex-1 mx-10">
            <div class="f15 f-600 lh-21 color-555555 flex-h-start mb-3">
              <span>每日宝箱</span>
